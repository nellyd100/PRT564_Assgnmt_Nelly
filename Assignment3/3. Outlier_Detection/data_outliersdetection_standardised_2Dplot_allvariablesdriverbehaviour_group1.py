...
myFilename = 'TrainingDriverBehaviourData.csv'

# Define the data variable names
myNames = ['Season', 'Occupants', 'Age', 'Sex', 'Aboriginal', 'Day', 'Alcohol', 'Drugs', 'Circumstance',
            'RUMDesc', 'Pedestrian', 'Cyclist', 'DriverClass']

# read dataset
myDataframe = read_csv(myFilename, names=myNames)

# Retrieve explanatory variable columns 
myExplanatoryvariables = myDataframe.columns[0:12]
...
plt.title('Driver Behaviour 2D Outlier Detection with Standardisation')
